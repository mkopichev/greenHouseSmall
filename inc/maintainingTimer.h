...
// TEMP_SETPOINT_DELTA - if temperature over TEMP_SETPOIT+TEMP_SETPOINT_DELTA, cooling fan turn on
...
#define TEMP_SETPOINT_DELTA 5.0F  // oC
#define LIGHT_SETPOINT      0.6F  // %
#define MOISTURE_SETPOINT   0.8F  // %
